...
case "$1" in
	f33_arm64)
	    DOCKERIMAGE=https://mirror.umd.edu/fedora/linux/releases/33/Container/aarch64/images/Fedora-Container-Base-33-1.2.aarch64.tar.xz
	    ;;
        f32_arm64)
	...
	uninstall)
	    ...
	    ;;
	*)
	    echo $"Usage: $0 {f33_arm64|f32_arm64|uninstall}"
	    exit 2
	    ;;
esac
